...
export default function ScheduleInfo() {
  ...
  const [activeTab, setActiveTab] = useState<
    "teams" | "facilities" | "schools" | "rankings" | "rules"
  >("teams")
              ...
              {info.facilities.map((facility) => (
                ...
                >
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="text-gray-600 dark:text-gray-300">
                      <span className="font-medium">Max Courts:</span>{" "}
                      {facility.max_courts}
                    </div>
                    <div className="text-gray-600 dark:text-gray-300">
                      <span className="font-medium">8ft Rims:</span>{" "}
                      {facility.has_8ft_rims ? "Yes" : "No"}
                    </div>
                    <div className="text-gray-600 dark:text-gray-300">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-2 text-sm">
                  <div className="text-gray-600 dark:text-gray-300">
                    ...
                    {info.scheduling_rules.season.start_date}
                  </div>
                  <div className="text-gray-600 dark:text-gray-300">
                    <span className="font-medium">End:</span>{" "}
                    {info.scheduling_rules.season.end_date}
                  </div>
                  <div className="text-gray-600 dark:text-gray-300">
                    <span className="font-medium">Game Duration:</span>{" "}
                    {info.scheduling_rules.game_duration.minutes} minutes
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    <div className="text-gray-600 dark:text-gray-300">
                      {info.scheduling_rules.time_rules.weeknight.start_time} -{" "}
                      {info.scheduling_rules.time_rules.weeknight.end_time}
                    </div>
                    <div className="text-gray-500 dark:text-gray-400 text-xs mt-1">
                      {info.scheduling_rules.time_rules.weeknight.slots} time
                      slots
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="text-gray-600 dark:text-gray-300">
                      {info.scheduling_rules.time_rules.saturday.start_time} -{" "}
                      {info.scheduling_rules.time_rules.saturday.end_time}
                    </div>
                  </div>
                  <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
                    <div className="text-gray-600 dark:text-gray-300">
                      <span className="font-medium">Sunday Games:</span>{" "}
                      {info.scheduling_rules.time_rules.no_sunday_games
                        ? "Not Allowed"
                        : "Allowed"}
                    </div>
                  </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-2 text-sm">
                  <div className="text-gray-600 dark:text-gray-300">
                    <span className="font-medium">Max games per 7 days:</span>{" "}
                    {info.scheduling_rules.frequency_rules.max_games_per_7_days}
                  </div>
                  <div className="text-gray-600 dark:text-gray-300">
                    <span className="font-medium">Max games per 14 days:</span>{" "}
                    {
                      info.scheduling_rules.frequency_rules
                        .max_games_per_14_days
                    }
                  </div>
                  <div className="text-gray-600 dark:text-gray-300">
                    <span className="font-medium">
                      Max doubleheaders per season:
                    </span>{" "}
                    {
                      info.scheduling_rules.frequency_rules
                        .max_doubleheaders_per_season
                    }
                  </div>
                  <div className="text-gray-600 dark:text-gray-300">
                    <span className="font-medium">Doubleheader break:</span>{" "}
                    {
                      info.scheduling_rules.frequency_rules
                        .doubleheader_break_minutes
                    }{" "}
                    minutes
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {info.scheduling_rules.recreational_divisions.map(
                        (div) => (
                          <span
                            key={div}
                  ...
                  <div>
                    <div className="font-medium text-gray-700 dark:text-gray-300 mb-2">
                      ES K-1 REC Priority Sites:
                    </div>
                    <div className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
                      {info.scheduling_rules.es_k1_rec_special.priority_sites.map(
                        (site) => (
